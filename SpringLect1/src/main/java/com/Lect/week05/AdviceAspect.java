...
public class AdviceAspect {
	...
	@Before("execution(* com.Lect.Service.week05.ExAOPService.performSensitiveOperation(..))")
	...
	@Pointcut ("execution(* com.Lect.Service...*(..))")
	...
	public void exceptionProcess(Throwable authException) {
		System.out.println("========================================");
		System.out.println("예외 발생!!, 예외= "+authException.getMessage());
